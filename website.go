...
const (
	...
	PAGE_STATIC_SLA_RANGE_MAX     = 5
	PAGE_DYNAMIC_SLA_RANGE_MIN    = 0
	PAGE_DYNAMIC_SLA_RANGE_MAX    = 100
	DATA_PROCESS_FG_SLA_RANGE_MIN = 300
	DATA_PROCESS_FG_SLA_RANGE_MAX = 500
	DATA_PROCESS_BG_SLA_RANGE_MIN = 200
	DATA_PROCESS_BG_SLA_RANGE_MAX = 5000
